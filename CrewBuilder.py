...
class AgentFlowApplication:
    ...
    def setup_toolbar(self):
        ...
        # Enable Analyze button by default for testing
    ...
    def analyze_recording(self):
        ...
        try:
            ...
            # )
            workflow_data = """{
  "system_goal": "The user is using the ACI money transfer system to repair payment messages/transactions.",
  "activities_for_goal": ["1", "2"],
  "activities": [
    {
      "activity_name": "Select a Queue",
      "activity_no": "1",
      "activity_steps": [
        {
          "activity_step_no": "1",
          "activity_step_rationale": "To start repairing a transaction, the user needs to select a queue with a transaction for which repair needs to be done.",
          "activity_step_type": "Click Dropdown",
          "activity_step_control": "Priority",
          "activity_step_desc": "Click on the dropdown corresponding to the first row in the table of queues on the home page.",
          "activity_screen_desc": "Screen has a title [ACI MONEY TRANSFER SYSTEM] at the top left of the page and a heading [Queue Summary: 3 messages] below that."
        },
        {
          "activity_step_no": "2",
          "activity_step_rationale": "After clicking on the dropdown, the user will see a list of priority values; the user will select the first value which is '1'.",
          "activity_step_type": "Click",
          "activity_step_control": "1",
          "activity_step_desc": "Select the second index which is value '1' from the dropdown list.",
          "activity_screen_desc": "Screen shows the list of values 1, 2, 3 for the dropdown in the previous step."
        }
      ]
    },
    {
      "activity_name": "Select a Transaction",
      "activity_no": "2",
      "activity_steps": [
        {
          "activity_step_no": "1",
          "activity_step_rationale": "To repair the first transaction, the user needs to select the first transaction from the list of transactions.",
          "activity_step_type": "Click Link",
          "activity_step_control": "20241204-00649915",
          "activity_step_desc": "Since the first transaction has to be repaired in the queue, select the first TRN from the table to view the transaction details.",
          "activity_screen_desc": "Screen has a heading [Queue Summary: 2 messages] and a table of transactions with columns [TRN, Sender ID/Debit Account, Receiver]."
        }
      ]
    }
  ]
